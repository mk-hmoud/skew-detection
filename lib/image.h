...
public:
    ...
    inline ColorImage(const GrayscaleImage &);
...
inline void SaveHist(const GrayscaleImage &im, std::string filename, float scale = 0.05)
{
...
inline void SaveHist(const ColorImage &im, std::string filename, float scale = 0.05)
{
